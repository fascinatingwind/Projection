...
{
	FMatrix3x3 matrix(
		FPoint3D{ 1.f, 0.f, 0.f },
		FPoint3D{ 0.f, 1.f, 0.f },
		FPoint3D{ 0.f, 0.f, 1.f });
...
{
	FMatrix3x3 matrix(
		FPoint3D{ 2.f, 0.f, 1.f },
		FPoint3D{ 0.f, 1.f, 0.f },
		FPoint3D{ 1.f, 0.f, 3.f });
...
{
	FMatrix3x3 matrix(
		FPoint3D{ 1.f, 2.f, 3.f },
		FPoint3D{ 1.f, 1.f, 2.f },
		FPoint3D{ 3.f, 2.f, 2.f });
